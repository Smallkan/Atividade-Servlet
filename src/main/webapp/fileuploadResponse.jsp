...
<html lang="pt-br">
  ...
  <div class="text-center mb-8">
    <a href="/AtividadeServlet"></a><img class="mb-4" src="resource/img/logo.jpg" alt="" width="170" height="auto" border="0"></a>
  </div>
	<br />
                     	...
                     	<td align="center"><span id="fileSize"><%=uploadDetails.get(i).getFileSize() %> KB</span></td>
                  	 	...
                  	 	<td align="center">
                  	 		<span id="fileDownload">
                  	 			<a id="downloadLink" class="hyperLink" href="<%=request.getContextPath()%>/<%=uploadDetails.get(i).getFileName() %>">Visualizar</a> / 
